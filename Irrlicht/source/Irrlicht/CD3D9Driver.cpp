...
void CD3D9Driver::enableScissor(bool enable)
{
	pID3DDevice->SetRenderState(D3DRS_SCISSORTESTENABLE, enable ? TRUE : FALSE);
}

void CD3D9Driver::setScissorRect(s32 x, s32 y, s32 width, s32 height)
{
	RECT scissor;
	scissor.left = x;
	scissor.top = y;
